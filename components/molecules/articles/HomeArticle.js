  export default function HomeArticle({bgColor = "red",  children = "Nom du produit", alt = "home-article", className= ""}) {
    return (
        <div className={`lg:h-[345px] lg:w-[225px] h-[250px] lg:px-0 500:pl-10 pl-5 500:pr-28 pr-0 500:w-2/3 350:w-[90%] w-full lg:block flex items-center justify-between flex-row-reverse lg:rotate-[10deg] rounded-r-md lg:rounded-t-md  bg-${bgColor} relative`}>
            <img src="/assets/img/example.png" alt={alt} className={`${className} lg:w-auto lg:h-auto 500:h-[85%] 350:h-[60%] h-[35%] aspect-square 500:absolute right-0  500:translate-x-1/2 lg:translate-x-0 lg:-top-20`} />
